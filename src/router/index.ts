...
import RepairsDaily from '../views/repairs.daily.vue'
...
const routes = [
  ...
  { path: '/resources/building', name: 'ResourcesBuilding', component: () => import('../views/resources.building.vue') },
  ...
  { path: '/service/repairs/daily', name: 'ServiceRepairsDaily', component: RepairsDaily },
  { path: '/service/public', name: 'ServicePublic', component: () => import('../views/service.public.vue') },
  ...
  // 招商租赁
  { path: '/leasing/contract', name: 'LeasingContract', component: () => import('../views/Placeholder.vue') },
  ...
  // 物业管理
  { path: '/property/meter', name: 'PropertyMeter', component: () => import('../views/Placeholder.vue') },
  ...
  // 财务管理 - 财务报表
  { path: '/finance/reports/feeReport', name: 'FinanceReportsFeeReport', component: () => import('../views/Placeholder.vue') },
